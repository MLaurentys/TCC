...
\node {
	...
	\end{tikzpicture}}
child[blue, level distance=80pt] {node[black] {\begin{tikzpicture}
			\draw[] (0.6,-0.6) rectangle ++(0.3,0.3);
...
child[blue] {node[black] {\begin{tikzpicture}
			\draw[] (0.6,-0.6) rectangle ++(0.3,0.3);
			\draw[] (0.3,-0.6) rectangle ++(0.3,0.3);
			\draw[] (0.9,-0.6) rectangle ++(0.3,0.3);
...
child[red, dashed, level distance=80pt] {node[black, solid] { \begin{tikzpicture}
...
child[red, dashed] {
	node[black, solid] { \begin{tikzpicture}
	\draw[] (0.6,-0.6) rectangle ++(0.3,0.3);
	\draw[fill=gray] (0.3,-0.6) rectangle ++(0.3,0.3);
	\draw[] (0.9,-0.6) rectangle ++(0.3,0.3);
	\draw[fill=gray] (0,-0.6) rectangle ++(0.3,0.3);
...
\end{tikzpicture}
\end{center}
\caption{Partial game tree of a hot game}
\end{figure}