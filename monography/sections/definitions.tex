...
The notations is exactly the same for numbers, but they should not be confused. For a game  \Gm{= \gam{X}{Y} = \gam{x_1, \ldots, x_n}{y_1, \ldots, y_m}} to be a number, it must be true that $X < Y$, meaning that:
